...
!(function($) {
  ...
  (MorrisCharts.prototype.createLineChart = function(
    ...
    (MorrisCharts.prototype.init = function() {
                                                ...
                                                this.createLineChart("vin_vmcu_10m", $vin_vmcu, "y", ["a", "b", "c"], ["Series A", "Series B", "Series c"], ["#3bc0c3", "#1a2942", "#dcdcdc"]);
                                                ...
                                                // //create line chart
                                                // var $data = [{ y: "2009", a: 100, b: 90, c: 75 }, { y: "2010", a: 75, b: 65, c: 50 }, { y: "2011", a: 50, b: 40, c: 30 }, { y: "2012", a: 75, b: 65, c: 50 }, { y: "2013", a: 50, b: 40, c: 22 }, { y: "2014", a: 75, b: 65, c: 50 }, { y: "2015", a: 100, b: 90, c: 65 }];
                                                // this.createLineChart("morris-line-example", $data, "y", ["a", "b", "c"], ["Series A", "Series B", "Series C"], ["#1a2942", "#3bc0c3", "#dcdcdc"]);

                                                // //creating area chart
                                                // var $areaData = [{ y: "2009", a: 10, b: 20 }, { y: "2010", a: 75, b: 65 }, { y: "2011", a: 50, b: 40 }, { y: "2012", a: 75, b: 65 }, { y: "2013", a: 50, b: 40 }, { y: "2014", a: 75, b: 65 }, { y: "2015", a: 90, b: 60 }];
