        ...
        document.getElementById('submitbutton').disabled = !cansubmit;
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}" name = "LoginForm">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" onKeyup="checkform()" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="password" onKeyup="checkform()" required>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                <input id="submitbutton" type="submit" disabled="disabled" value="Submit" class="btn btn-primary" />
