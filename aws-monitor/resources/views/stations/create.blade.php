                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="wizard-validation-form" method="post" action="/" style="margin-bottom: 30px;">
                                <div>
                                    {{ csrf_field() }}
                                    ...
                                    <section style="padding-bottom:30px;">
                                        ...
                                        <div class="form-group clearfix">
                                            <label class="col-lg-2 control-label " for="sphone">Station Mobile
                                                Number</label>
                                            <div class="col-lg-4">
                                                <input id="sphone" name="sphone" type="tel" class="form-control" required>
                                            </div>
                                        </div>
