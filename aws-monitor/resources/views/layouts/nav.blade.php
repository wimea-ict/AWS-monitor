...
<!-- 
            <li class="">
                <a href="URL::to('livedata')}}"><i class="ion-radio-waves"></i> <span class="nav-label">Live-Data</span></a>
...
@if (Auth::user()->station == NULL)
       ...
       <li class="has-submenu">
                <a href="{{URL::to('display_users')}}"><i class="ion-stats-bars"></i> <span class="nav-label">System Users</span></a>
            </li>
