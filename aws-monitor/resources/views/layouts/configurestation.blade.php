                                    ...
                                    <form id="" method="post" action="{{ url('updateStation') }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="" style="display:none">
                                                <input class="form-control" id="station_number" name="station_number"
                                                    type="text">
                                            </div>
                                            <section style="padding-bottom:30px;">
                                                <div class="form-group clearfix">
                                                    <div class="col-sm-12  control-label text-right">
                                                        <label class="switch">
                                                            <input type="checkbox" name="station_status" required value="on"
                                                                checked>
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input class="form-control" id="station_name" name="station_name"
                                                            type="text" readonly>
                                                    </div>
                                                    <label class="col-lg-2 control-label" for="snumber">Station
                                                        number</label>
                                                    <div class="col-lg-4">
                                                ...
                                                <div class="form-group clearfix">
                                                    <label class="col-lg-2 control-label " for="slocation">Station
                                                        location</label>
                                                    <div class="col-lg-4">
                                                        <input id="slocation" name="slocation" type="text"
                                                ...
                                                <div class="form-group clearfix">
                                                    <label class="col-lg-2 control-label " for="station_type">station
                                                        Type</label>
                                                    <div class="col-lg-4">
                                                        <input id="station_type" name="station_type" type="text"
                                                            class="form-control" required>
                                                    </div>
                                                    <label class="col-lg-2 control-label "
                                                        for="station_type">Country</label>
                                                    <div class="col-lg-4">
