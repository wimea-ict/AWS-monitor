...
class CreateTenMeterNodeTable extends Migration {
	...
	public function up()
	{
		Schema::create('TenMeterNode', function(Blueprint $table)
		{
			...
			$table->string('V_AD1', 200)->nullable();
			$table->string('V_AD2', 200)->nullable();
			...
			$table->string('windSpeed', 200)->nullable();
		});
	}
