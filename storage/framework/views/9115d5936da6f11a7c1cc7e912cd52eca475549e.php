...
<div class="row">
                ...
                <div id="full-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="full-width-modalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> 
                                <h3 class="panel-title">Edit Station Demographics</h3> 
                            </div> 
                            <div class="panel-body"> 
                                <form id="wizard-validation-form" method="post" action="<?php echo e(url('updateStation')); ?>" style="margin-bottom: 30px;">
                                    <div>
                                    <?php echo e(csrf_field()); ?>
                                        ...
                                        <section>
                                            <div class="col-lg-12">
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input class="form-control" id="10name" name="10name" type="text"  disabled>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="collapsefour-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="10vin_label" name="10vin_label" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10txt_key">TXT key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10txt_key" name="10txt_key" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10mac_add">MAK key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10mac_add" name="10mac_add" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10v_in_min_value">v_in min value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10v_in_min_value" name="10v_in_min_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10v_in_max_value">v_in max value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10v_in_max_value" name="10v_in_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="userName2">v_mcu label</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10v_mcu_label" name="10v_mcu_label" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10gwlat">latitude key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10gwlat" name="10gwlat" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10gwlong">longitude key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10gwlong" name="10gwlong" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10v_mcu_max_value">v_mcu max value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10v_mcu_max_value" name="10v_mcu_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10v_mcu_min_value">v_mcu min value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10v_mcu_min_value" name="10v_mcu_min_value" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10rssi">RSSI key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10rssi" name="10rssi" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10lqi">LQI key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10lqi" name="10lqi" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10drp">drp key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10drp" name="10drp" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10ttl">TTL key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10ttl" name="10ttl" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10date">Date identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10date" name="10date" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10time">Time identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10time" name="10time" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="10date">PS key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10ps" name="10ps" type="text" class="form-control" >
                                                                                </div>
                                                    ...
                                                    <div id="collapseOne-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="10parameter_read" name="10parameter_read" type="text" class="form-control"  disabled>
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10identifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10identifier_used" name="10identifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="10max_value" name="10max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10min_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="10min_value" name="10min_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="collapseTwo-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="wsparameter_read" name="wsparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="wsidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="wsidentifier_used" name="wsidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="wsmax_value" name="wsmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="wsmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="wsmin_value" name="wsmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div> 
                                                        </div>
                                                    </div> 
                                                    ...
                                                    <div id="collapseThree-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="wdparameter_read" name="wdparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="wdidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="wdidentifier_used" name="wdidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="wdmax_value" name="wdmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="wdmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="wdmin_value" name="wdmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div> 
                                                        </div> 
                                                    </div> 
                                        ...
                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input class="form-control" id="2mname" name="2mname" type="text"  disabled>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="collapsesix-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="2mvin_label" name="2mvin_label" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2mv_in_min_value">v_in_min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2mv_in_min_value" name="2mv_in_min_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="2gwlat" name="2gwlat" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2gwlong">longitude key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2gwlong" name="2gwlong" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="2mv_in_max_value">v_in_max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2mv_in_max_value" name="2mv_in_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2mv_mcu_label">v_mcu_label</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2mv_mcu_label" name="2mv_mcu_label" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="2mv_mcu_max_value" name="2mv_mcu_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2mv_mcu_min_value">v_mcu_min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2mv_mcu_min_value" name="2mv_mcu_min_value" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="2rssi">RSSI key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2rssi" name="2rssi" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2lqi">LQI key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2lqi" name="2lqi" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="2drp">drp key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2drp" name="2drp" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2ttl">TTL key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2ttl" name="2ttl" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="2date">Date identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2date" name="2date" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="2time">Time identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="2time" name="2time" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                ...
                                                <div class="panel panel-default"> 
                                                    ...
                                                    <div id="collapseseven-2" class="panel-collapse collapse"> 
                                                        ...
                                                        <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="rhparameter_read" name="rhparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="rhidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="rhidentifier_used" name="rhidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="rhmax_value" name="rhmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="rhmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="rhmin_value" name="rhmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="collapseeight-2" class="panel-collapse collapse"> 
                                                        ...
                                                        <div class="form-group clearfix">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="tsparameter_read" name="tsparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="tsidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="tsidentifier_used" name="tsidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="tsmax_value" name="tsmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="tsmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="tsmin_value" name="tsmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>  
                                                        </div> 
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input class="form-control" id="gdname" name="gdname" type="text" >
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="collapsenight-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndvin_label" name="gndvin_label" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="10txt_key">TXT key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndtxt_key" name="gndtxt_key" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="gdv_mcu_max_value">v_mcu_max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gdv_mcu_max_value" name="gdv_mcu_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="gdv_mcu_min_value">v_mcu_min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gdv_mcu_min_value" name="gdv_mcu_min_value" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="gdv_in_max_value">v_in_max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gdv_in_max_value" name="gdv_in_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="gdv_mcu_label">v_mcu_label</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gdv_mcu_label" name="gdv_mcu_label" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="gndmac_add">MAK key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndmac_add" name="gndmac_add" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="gndv_in_min_value">v_in min value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndv_in_min_value" name="gndv_in_min_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndgwlat" name="gndgwlat" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="gndgwlong">longitude key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndgwlong" name="gndgwlong" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndrssi" name="gndrssi" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="gndlqi">LQI key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndlqi" name="gndlqi" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="gnddrp">drp key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gnddrp" name="gnddrp" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="gndttl">TTL key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gndttl" name="gndttl" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="gnddate">Date identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="gnddate" name="gnddate" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="grndtime">Time identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="grndtime" name="grndtime" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="groundps">PS key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="groundps" name="groundps" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="groundrain_pulses">Rain Pulses</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="groundrain_pulses" name="groundrain_pulses" type="text" class="form-control" >
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="groundpo" name="groundpo" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="groundup">Rain Pulses</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="groundup" name="groundup" type="text" class="form-control" >
                                                                                </div>
                                                    ...
                                                    <div id="collapseten-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="ppparameter_read" name="ppparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="ppidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="ppidentifier_used" name="ppidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="ppmax_value">max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="ppmax_value" name="ppmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="ppmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="ppmin_value" name="ppmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="collapseeleven-2" class="panel-collapse collapse"> 
                                                        ...
                                                        <div class="form-group clearfix">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="stparameter_read" name="stparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="stidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="stidentifier_used" name="stidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="stmax_value">max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="stmax_value" name="stmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="stmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="stmin_value" name="stmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>  
                                                        </div> 
                                                    </div>
                                                    ...
                                                    <div id="collapsetweleve-2" class="panel-collapse collapse"> 
                                                        ...
                                                        <div class="form-group clearfix">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="smparameter_read" name="smparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="smidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="smidentifier_used" name="smidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="smmax_value">max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="smmax_value" name="smmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="smmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="smmin_value" name="smmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>  
                                                        </div> 
                                                    </div> 
                                        ...
                                        <div class="col-lg-12">
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input class="form-control" id="sinkname" name="sinkname" type="text" >
                                                                                </div>
                                                    ...
                                                    <div id="collapsethirteen-2" class="panel-collapse collapse"> 
                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkvin_label" name="sinkvin_label" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinktxt_key">TXT key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinktxt_key" name="sinktxt_key" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="sinkv_mcu_max_value">v_mcu_max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkv_mcu_max_value" name="sinkv_mcu_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinkv_mcu_min_value">v_mcu_min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkv_mcu_min_value" name="sinkv_mcu_min_value" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="sinkv_in_max_value">v_in_max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkv_in_max_value" name="sinkv_in_max_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinkv_mcu_label">v_mcu_label</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkv_mcu_label" name="sinkv_mcu_label" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="sinkmac_add">MAK key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkmac_add" name="sinkmac_add" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinkv_in_min_value">v_in min value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkv_in_min_value" name="sinkv_in_min_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkgwlat" name="sinkgwlat" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinkgwlong">longitude key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkgwlong" name="sinkgwlong" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkrssi" name="sinkrssi" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinklqi">LQI key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinklqi" name="sinklqi" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="sinkdrp">drp key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkdrp" name="sinkdrp" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinkttl">TTL key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkttl" name="sinkttl" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="sinkdate">Date identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkdate" name="sinkdate" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="sinktime">Time identifier</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinktime" name="sinktime" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="sinkps">PS key</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="sinkps" name="sinkps" type="text" class="form-control" >
                                                                                </div>
                                                ...
                                                <div class="panel panel-default"> 
                                                    ...
                                                    <div id="collapsefourteen-2" class="panel-collapse collapse"> 
                                                        ...
                                                        <div class="form-group clearfix">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <input id="psparameter_read" name="psparameter_read" type="text" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="psidentifier_used">Identifier used</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="psidentifier_used" name="psidentifier_used" type="text" class="form-control" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group clearfix">
                                                                                <label class="col-lg-2 control-label " for="psmax_value">max_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="psmax_value" name="psmax_value" type="number" class="form-control" >
                                                                                </div>
                                                                                <label class="col-lg-2 control-label " for="psmin_value">min_value</label>
                                                                                <div class="col-lg-4">
                                                                                    <input id="psmin_value" name="psmin_value" type="number" class="form-control" >
                                                                                </div>
                                                                            </div>
