        ...
        <script src="<?php echo e(asset('assets/chat/moment-2.2.1.js')); ?>"></script>

        <!-- Counter-up -->
        <script src="<?php echo e(asset('js/waypoints.min.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset('js/jquery.counterup.min.js')); ?>" type="text/javascript"></script>

        <!-- EASY PIE CHART JS -->
        <script src="<?php echo e(asset('assets/easypie-chart/easypiechart.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/easypie-chart/jquery.easypiechart.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/easypie-chart/example.js')); ?>"></script>


        <!--C3 Chart-->
        <script src="<?php echo e(asset('assets/c3-chart/d3.v3.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/c3-chart/c3.js')); ?>"></script>

        <!--Morris Chart-->
        <script src="<?php echo e(asset('assets/morris/morris.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/morris/raphael.min.js')); ?>"></script>

       

        <!-- sparkline --> 
        <script src="<?php echo e(asset('assets/sparkline-chart/jquery.sparkline.min.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset('assets/sparkline-chart/chart-sparkline.js')); ?>" type="text/javascript"></script> 

        <!-- sweet alerts -->
        <script src="<?php echo e(asset('assets/sweet-alert/sweet-alert.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/sweet-alert/sweet-alert.init.js')); ?>"></script>

        <script src="<?php echo e(asset('js/jquery.app.js')); ?>"></script>
        <!-- Chat -->
        <script src="<?php echo e(asset('js/jquery.chat.js')); ?>"></script>
        <!-- Dashboard -->
        <script src="<?php echo e(asset('js/jquery.dashboard.js')); ?>"></script>

        <!-- Todo -->
        <script src="<?php echo e(asset('js/jquery.todo.js')); ?>"></script>

         <?php echo $__env->yieldContent("page_specific_script_files"); ?>

        <!--Form Wizard-->
        <script src="<?php echo e(asset('assets/form-wizard/jquery.steps.min.js')); ?>" type="text/javascript"></script>
        <script type="text/javascript" src="<?php echo e(asset('assets/jquery.validate/jquery.validate.min.js')); ?>"></script>

        <!--wizard initialization-->
        <script src="<?php echo e(asset('assets/form-wizard/wizard-init.js')); ?>" type="text/javascript"></script>
        ...
        <script src="<?php echo e(asset('assets/datatables/dataTables.bootstrap.js')); ?>"></script>
         ...
         <!-- Modal-Effect -->
         <script src="<?php echo e(asset('assets/modal-effect/js/classie.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/modal-effect/js/modalEffects.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/select2/select2.min.js')); ?>" type="text/javascript"></script>


        <script src="<?php echo e(asset('assets/toggles/toggles.min.js')); ?>"></script>
       
    


        <script src="<?php echo e(asset('assets/dygraph/dygraph.min.js')); ?>" ></script>
