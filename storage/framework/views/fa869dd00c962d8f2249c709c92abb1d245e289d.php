                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <?php $__currentLoopData = $stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $station): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-icon btn-success m-b-5 edit-station-button" data-toggle="modal" id="<?php echo e(htmlspecialchars(json_encode(array($station, $problemConfigurationvalues)))); ?>" data-target="#full-width-modal7"  data-delete-link="" > <i class="fa fa-edit"></i> Edit </button></td>
                                                </tr>
