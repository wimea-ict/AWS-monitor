...
<div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                            <?php $__currentLoopData = $groundNodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groundNode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal-dialog modal-full">
                        <div class="modal-content">
                           ...
                           <div class="row">
                           <div class="col-lg-12">
                           <form novalidate method="post" action="<?php echo e(url('updateGroundNode')); ?>">
